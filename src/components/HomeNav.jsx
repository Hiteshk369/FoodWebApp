...
const HomeNav = () => {
  ...
  return (
    <div className='w-screen h-auto flex justify-evenly' style={{
        ...
        <div className='w-full small:hidden md:flex h-full  ml-36 mr-48 mb-3 '>
            ...
            <div className="text-3xl flex items-center ml-48 justify-center font-semibold">
               <p className='font-poppins'>{item}</p>
            </div>
            <ul className="flex gap-10 items-center justify-center ml-auto">
                    ...
                    }} /></span>
                {
                    isfilter && (
                        <div className = 'absolute flex flex-col w-40 top-11 right-3 gap-1 z-50 font-normal text-black bg-white text-base border rounded-lg p-2 border-gray-300'>
                            <p className = 'px-2 py-1 hover:bg-slate-200 rounded-lg' onClick={() => dispatch({type : 'SET_FILTER_ITEM', filterItem : 'All Dishes' }) }>All Dishes</p>
                            {
        ...
        <div className='md:hidden w-full flex h-full '>
            <div className="text-2xl ml-6 flex items-center justify-center font-semibold">
               <p className='font-poppins'>{item}</p>
            </div>
            <ul className="flex gap-10 items-center justify-center ml-auto">
                <li onClick = {openFilter} className='relative font-semibold text-lg flex items-center justify-center mr-6 cursor-pointer hover:text-orangeColor'>
                    <p className='font-poppins'>Filters</p>
                    <span className='pl-2'><HiOutlineAdjustmentsVertical size='40' color='#ffa700' style={{
                        'padding':'8px',
                        'borderRadius':'50%',
